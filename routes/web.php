...
Route::middleware('auth')->group(function () {
    ...
    Route::get('download/pdf', [TicketController::class, 'download'])->name('tickets.download');
    Route::get('/tickets/export/excel', [TicketController::class, 'downloadExcel'])->name('tickets.export.excel');
    Route::middleware('auth')->get('/tickets/email/excel',[TicketController::class, 'emailExcel'])->name('tickets.email.excel');
